    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        DisplayName = c.String(maxLength: 120),
                        MetaData = c.String(),
                        Icon = c.String(),
                        Url = c.String(),
                        RequiresAuthentication = c.Boolean(nullable: false),
                        RequiredPermissions = c.String(),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.yt_menu", t => t.ParentId)
                .Index(t => t.ParentId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.yt_permission", t => t.ParentId)
                .Index(t => t.ParentId);
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.yt_permission", new[] { "ParentId" });
            ...
            DropIndex("dbo.yt_menu", new[] { "ParentId" });
            DropIndex("dbo.AbpFeatures", new[] { "EditionId" });
            DropIndex("dbo.AbpBackgroundJobs", new[] { "IsAbandoned", "NextTryTime" });
            DropTable("dbo.yt_permission");
            ...
            DropTable("dbo.yt_objectstorage");
