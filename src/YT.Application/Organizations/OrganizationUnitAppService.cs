...
{/// <summary>
 ...
 [DisableAuditing]
    public class OrganizationUnitAppService : YtAppServiceBase, IOrganizationUnitAppService
    {
        ...
        private readonly IRepository<Organization, long> _organizationUnitRepository;
        ...
        public OrganizationUnitAppService(
            ...
            IRepository<Organization, long> organizationUnitRepository,
        ...
        {
            var organizationUnit = new Organization(AbpSession.TenantId, input.DisplayName, input.ParentId)
            {
                Type = input.Type
            };
