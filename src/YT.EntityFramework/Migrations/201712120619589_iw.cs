namespace YT.Migrations
{
    ...
    public partial class iw : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                {
                    { "DynamicFilter_Adsence_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CustomerForm", t => t.FormId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.FormProfile", "ProfileId", "dbo.milk_objectstorage");
            DropForeignKey("dbo.FormProfile", "FormId", "dbo.CustomerForm");
            ...
            DropIndex("dbo.FormProfile", new[] { "ProfileId" });
            DropIndex("dbo.FormProfile", new[] { "FormId" });
